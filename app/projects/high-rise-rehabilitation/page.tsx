...
const scopeItems = [
  { label: "Concrete Condition Assessment", detail: "Full exterior survey including carbonation testing, half-cell potential mapping, and concrete core sampling" },
  { label: "Concrete Repair Specifications", detail: "Patch repair, crack injection, and overlay specifications developed per ACI 224R and CSA A23.1" },
  { label: "Balcony Structural Strengthening", detail: "CFRP overlay and new edge support design for deteriorated balcony slabs requiring structural enhancement" },
  { label: "Cathodic Protection Design", detail: "Impressed current cathodic protection system specified to arrest ongoing reinforcement corrosion" },
  { label: "Construction Monitoring", detail: "Site observation and contractor guidance throughout the rehabilitation construction program" },
]

const keyFacts = [
  { label: "Location", value: "Vancouver, BC" },
  { label: "Building Type", value: "High-Rise Residential Tower" },
  { label: "Services", value: "Building Rehabilitation & Structural Assessment" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">HIGH-RISE</span>
                <br />
                <span className="text-[#0052A5]">REHABILITATION</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Comprehensive structural rehabilitation of an aging high-rise residential tower in Vancouver, addressing concrete deterioration, balcony structural deficiencies, and envelope integrity.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-9.png" alt="HIGH-RISE REHABILITATION" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">HIGH-RISE</span>
                      <span className="block text-[#0052A5]">REHABILITATION</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Comprehensive structural rehabilitation of an aging high-rise residential tower in Vancouver, addressing concrete deterioration, balcony structural deficiencies, and envelope integrity.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved a comprehensive structural assessment and rehabilitation program for an aging high-rise residential tower in Vancouver, BC. The building, constructed in the 1970s, exhibited significant concrete deterioration, corroding balcony slab reinforcement, and cracked spandrel beams — issues common in Vancouver's wet coastal climate.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering conducted a detailed field investigation, reviewed original structural drawings, and developed a phased rehabilitation program designed to restore structural integrity while minimizing disruption to the tower's occupied residential suites.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Accessing deteriorated concrete on the upper floors of an occupied high-rise required swing-stage scaffolding and careful coordination with building management to protect residents. Carbonation testing and half-cell potential surveys were conducted to map the extent of active reinforcement corrosion throughout the building exterior.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Many balcony slabs showed signs of delamination and spalling concrete, creating falling hazard risks to pedestrians below. Emergency stabilization netting was installed while the full assessment was completed and long-term repair specifications were developed and tendered to specialty concrete repair contractors.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Structural Assessment", body: "Full visual survey, carbonation depth testing, and half-cell potential mapping of all exterior concrete surfaces. Core sampling performed to assess concrete strength and rebar condition throughout." },
                  { step: "02", title: "Rehabilitation Design", body: "Concrete repair specifications developed including surface preparation, patch repair mix design, crack injection, and cathodic protection system design to arrest ongoing corrosion." },
                  { step: "03", title: "Balcony Structural Retrofit", body: "Structural strengthening designed for the most severely deteriorated balcony slabs, including new carbon fibre reinforced polymer (CFRP) overlay systems and new edge angle supports." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">RESTORED & SAFELY OCCUPIED</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The rehabilitation program successfully arrested the ongoing concrete deterioration and restored full structural capacity to the affected balcony slabs and spandrel beams. The tower has remained fully occupied throughout and since the rehabilitation, with no further structural incidents reported.</p>
                  </div>
                </div>
              </Reveal>
            </div>
