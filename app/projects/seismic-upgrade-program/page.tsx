...
const scopeItems = [
  { label: "Seismic Screening & Prioritization", detail: "Rapid screening of all portfolio buildings to establish vulnerability ranking and retrofit priority" },
  { label: "Soft-Storey Retrofit Design", detail: "Steel or concrete moment frame design for open tuck-under parking storey strengthening" },
  { label: "Cripple Wall Retrofit Design", detail: "Plywood sheathing and anchor bolt design for cripple wall strengthening in single-family homes" },
  { label: "As-Built Investigation", detail: "Field measurement and selective destructive investigation to establish existing framing configurations" },
  { label: "Permit Package Preparation", detail: "Standardized permit drawing templates coordinated with City of Vancouver for expedited review" },
]

const keyFacts = [
  { label: "Location", value: "Vancouver, BC" },
  { label: "Building Type", value: "Multiple Residential Buildings" },
  { label: "Services", value: "Seismic Assessment & Retrofit Design" },
  { label: "Jurisdiction", value: "City of Vancouver" },
  { label: "Code", value: "NBCC 2020 / BCBC 2018 / VBBL" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">SEISMIC UPGRADE</span>
                <br />
                <span className="text-[#0052A5]">PROGRAM</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">City-wide seismic upgrade program for a portfolio of older residential buildings in Vancouver, including tuck-under parking retrofit, soft-storey remediation, and cripple wall strengthening.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-16.png" alt="SEISMIC UPGRADE PROGRAM" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">SEISMIC UPGRADE</span>
                      <span className="block text-[#0052A5]">PROGRAM</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>City-wide seismic upgrade program for a portfolio of older residential buildings in Vancouver, including tuck-under parking retrofit, soft-storey remediation, and cripple wall strengthening.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project encompassed a seismic upgrade program for a portfolio of older wood-frame residential buildings in Vancouver — a priority initiative driven by Vancouver's Earthquake Preparedness Strategy. The buildings ranged from 1950s single-family homes with cripple wall foundations to 1970s multi-family buildings with soft-storey tuck-under parking conditions.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering performed individual seismic screenings and retrofit designs for each building in the portfolio, developing a standardized approach that could be adapted to each building's unique configuration. The program was coordinated with the City of Vancouver's permit department for streamlined review.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Soft-storey buildings with open tuck-under parking garages are among the most seismically vulnerable building types in Vancouver. Retrofitting these buildings required introducing new concrete or steel moment frames within the open garage storey without disrupting parking operations more than necessary during construction.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Many of the older wood-frame buildings had no original structural drawings, requiring as-built investigation and measurement to establish existing member sizes and connections before any retrofit analysis could begin. Selective destructive investigation was performed at each building to confirm framing sizes and connection details.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Portfolio Assessment", body: "Rapid seismic screening and detailed assessment of each building in the portfolio, prioritizing structures by vulnerability and occupancy to establish the retrofit sequencing plan." },
                  { step: "02", title: "Retrofit Design", body: "Individualized retrofit designs developed for each building: cripple wall plywood sheathing for single-family homes, and steel moment frames or concrete frames for soft-storey multi-family buildings." },
                  { step: "03", title: "Permit Coordination", body: "Standardized drawing templates developed to streamline permit submission for the portfolio. City of Vancouver coordinated with Zagrosia Engineering to establish an expedited review pathway for the program." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">PORTFOLIO UPGRADED ON SCHEDULE</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The seismic upgrade program was completed for all buildings in the portfolio within the project timeline. All retrofit designs received City of Vancouver permit approval, and post-construction inspections confirmed compliance with the retrofit specifications. The buildings are significantly better positioned to perform in a design seismic event.</p>
                  </div>
                </div>
              </Reveal>
            </div>
