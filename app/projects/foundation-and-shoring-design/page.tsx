...
const scopeItems = [
  { label: "Soldier Pile & Lagging Design", detail: "Temporary shoring wall design for 8m excavation including tieback capacity and wall deflection analysis" },
  { label: "Tieback Anchor Design", detail: "Post-installed tieback anchor design with capacity verified against geotechnical anchor testing program" },
  { label: "Permanent Foundation Design", detail: "Mat, spread footing, and pile cap design for the permanent below-grade structure" },
  { label: "Waterproof Concrete Specification", detail: "Waterproof concrete mix design and construction joint detailing for below-grade walls and slabs" },
  { label: "Dewatering Coordination", detail: "Coordination with geotechnical engineer on dewatering system design and groundwater management" },
]

const keyFacts = [
  { label: "Location", value: "Coquitlam, BC" },
  { label: "Building Type", value: "Mixed-Use Development" },
  { label: "Services", value: "Foundation Engineering & Shoring Design" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">FOUNDATION AND</span>
                <br />
                <span className="text-[#0052A5]">SHORING DESIGN</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Deep foundation and temporary shoring design for a new mixed-use development in Coquitlam, including soldier pile and lagging retaining system, pile cap design, and grade beam layout.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-13.png" alt="FOUNDATION AND SHORING DESIGN" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">FOUNDATION AND</span>
                      <span className="block text-[#0052A5]">SHORING DESIGN</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Deep foundation and temporary shoring design for a new mixed-use development in Coquitlam, including soldier pile and lagging retaining system, pile cap design, and grade beam layout.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project provided complete foundation and temporary shoring engineering for a new mixed-use development in Coquitlam, BC. The below-grade parkade excavation extended 8 metres below grade in an area with high groundwater and adjacent existing buildings — requiring a robust temporary earth retention system and a carefully designed permanent foundation.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering designed a soldier pile and lagging shoring wall for the excavation perimeter, coordinated with the geotechnical engineer to establish lateral earth pressures and surcharge loads from adjacent buildings and the city sidewalk at grade.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The proximity of an existing three-storey masonry building on the adjacent lot required a shoring system designed to limit lateral deformation of the retained soil to less than 25mm throughout the excavation. Tiebacks were installed through the shoring wall and anchored into the native glacial till to achieve the required stiffness.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>High groundwater encountered during excavation required continuous dewatering operations and waterproof concrete specifications for the permanent below-grade walls. The permanent concrete walls were designed to function as the structural water barrier without reliance on external waterproofing membrane systems alone.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Shoring System Design", body: "Soldier pile and lagging wall designed for 8m excavation depth with tiebacks anchored in glacial till. Deformation analysis performed to confirm adjacent building protection criteria were met." },
                  { step: "02", title: "Permanent Foundation Design", body: "Reinforced concrete spread and mat footings sized for building column loads and soil bearing capacity confirmed in the geotechnical report. Waterproof concrete mix and construction joint details specified." },
                  { step: "03", title: "Grade Beam & Pile Cap Layout", body: "Grade beam and pile cap layout designed to transfer column loads to the foundation elements with adequate shear and flexural capacity, coordinated with the architectural and mechanical plans." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">EXCAVATED & BUILT WITHOUT INCIDENT</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The shoring system performed within the 25mm deformation limit throughout excavation, and no damage was reported to the adjacent masonry building. The permanent foundation was constructed without groundwater incidents, and the development proceeded to above-grade construction on schedule.</p>
                  </div>
                </div>
              </Reveal>
            </div>
