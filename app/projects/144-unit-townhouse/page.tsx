...
const scopeItems = [
  { label: "Floor & Roof Framing Design", detail: "Complete gravity framing design including joists, beams, headers, and posts for all 144 units" },
  { label: "Shear Wall Engineering", detail: "Lateral load analysis and shear wall schedule development for seismic and wind resistance" },
  { label: "Hold-Down & Connector Design", detail: "Sizing of all hold-down anchors, Simpson connectors, and strap ties for shear wall uplift demands" },
  { label: "Foundation Design", detail: "Continuous footing and grade beam design coordinated with geotechnical report soil parameters" },
  { label: "Permit Drawing Set", detail: "Full structural drawings and calculations for City of Burnaby building permit submission" },
]

const keyFacts = [
  { label: "Location", value: "Burnaby, BC" },
  { label: "Building Type", value: "Multi-Family Residential (Wood Frame)" },
  { label: "Services", value: "Structural Design & Shear Wall Engineering" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">144-UNIT</span>
                <br />
                <span className="text-[#0052A5]">TOWNHOUSE</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Comprehensive structural design for a large-scale wood-frame townhouse complex including foundation systems, shear walls, and gravity load analysis across 144 residential units.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-4.png" alt="144-UNIT TOWNHOUSE" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">144-UNIT</span>
                      <span className="block text-[#0052A5]">TOWNHOUSE</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Comprehensive structural design for a large-scale wood-frame townhouse complex including foundation systems, shear walls, and gravity load analysis across 144 residential units.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved complete structural engineering for a 144-unit wood-frame townhouse development in Burnaby, BC. The complex consisted of multiple connected building blocks, each requiring individual gravity load design, shear wall layouts, and foundation systems coordinated across a challenging sloped site.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering provided full structural design services from preliminary layout through permit submission and construction administration. Close coordination with the project architect ensured shear wall locations were integrated into the architectural plan without compromising suite layouts or common corridor widths.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Designing lateral shear wall systems across 144 units required careful distribution of seismic and wind loads among dozens of individual shear walls. The architectural floor plans limited wall placement, requiring iterative optimization of shear wall lengths, locations, and hold-down anchorage to meet code drift limits.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The sloped site introduced differential foundation elevations across the complex, requiring stepped foundations and retaining wall design at grade transitions. Drainage and waterproofing coordination at the foundation level was critical to prevent moisture intrusion in below-grade storage areas.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Gravity Load Design", body: "Floor joist, beam, and post systems designed for each unit type under NBCC 2020 dead and live load combinations, including balcony and roof snow loads specific to Burnaby's snow zone." },
                  { step: "02", title: "Shear Wall Layout", body: "Lateral load distribution analysis performed for wind and seismic demands. Shear wall lengths, nailing schedules, and hold-down connector sizes optimized for each building block." },
                  { step: "03", title: "Foundation Design", body: "Strip footings and grade beams designed for the site's varying soil bearing conditions. Stepped foundations and retaining elements detailed for the sloped portions of the site." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">PERMITTED & BUILT ON SCHEDULE</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The 144-unit townhouse complex received structural permit approval from the City of Burnaby with no major revisions required. All building blocks passed structural inspection, and the project was delivered within the construction program timeline. The shear wall system performed within allowable drift limits under peer review.</p>
                  </div>
                </div>
              </Reveal>
            </div>
