...
const scopeItems = [
  { label: "GPR Tendon Mapping", detail: "Full deck ground-penetrating radar scan to locate all PT tendons prior to any cutting or drilling" },
  { label: "PT Condition Assessment", detail: "Selective destructive investigation to assess tendon corrosion levels and identify fractured elements" },
  { label: "Structural Repair Specifications", detail: "Supplemental reinforcement and concrete patch repair design for all structurally deficient areas" },
  { label: "Waterproofing System Design", detail: "New waterproofing membrane, drainage slope, and traffic topping specifications for the top deck" },
  { label: "Construction Phase Services", detail: "Site observation, tendon location verification, and repair contractor guidance throughout construction" },
]

const keyFacts = [
  { label: "Location", value: "Vancouver, BC" },
  { label: "Building Type", value: "Multi-Level Concrete Parkade" },
  { label: "Services", value: "Structural Restoration & PT Slab Assessment" },
  { label: "Jurisdiction", value: "City of Vancouver" },
  { label: "Code", value: "NBCC 2020 / BCBC 2018 / ACI 224R" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">CONCRETE PARKADE</span>
                <br />
                <span className="text-[#0052A5]">RESTORATION</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural restoration of a multi-level concrete parkade including post-tensioned slab assessment, concrete repair, waterproofing design, and drainage system upgrades.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-12.png" alt="CONCRETE PARKADE RESTORATION" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">CONCRETE PARKADE</span>
                      <span className="block text-[#0052A5]">RESTORATION</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural restoration of a multi-level concrete parkade including post-tensioned slab assessment, concrete repair, waterproofing design, and drainage system upgrades.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved comprehensive structural restoration of a multi-level post-tensioned concrete parkade in Vancouver. The parkade, built in the late 1980s, was experiencing ongoing water infiltration through the top deck slab, leading to PT tendon corrosion, concrete delamination, and active leaks onto the occupied floors below.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering performed a detailed PT tendon condition assessment using ground-penetrating radar and selective destructive investigation. A restoration design was developed addressing both structural repair of compromised PT elements and waterproofing system replacement to prevent future water ingress.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Post-tensioned concrete structures present unique rehabilitation challenges — cutting into the slab without severing live tendons requires careful GPR mapping and manual tendon location before any saw-cutting or core drilling. Two tendons were identified as fractured and required emergency restressing or supplemental non-PT reinforcement.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The parkade remained operational throughout the restoration, with vehicles required to access multiple levels at all times. Work zones were rotated across the deck in phases to maintain accessibility while allowing full restoration of each zone before moving to the next.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "PT Tendon Assessment", body: "Ground-penetrating radar scanning and selective destructive investigation to map all tendon locations, identify fractured tendons, and assess waterproofing membrane condition across the full deck area." },
                  { step: "02", title: "Structural Repair Design", body: "Supplemental non-PT reinforcement designed to replace the load-carrying contribution of fractured tendons. Concrete patch repair specifications developed for all delaminated and spalled areas." },
                  { step: "03", title: "Waterproofing System Design", body: "New hot-applied rubberized asphalt waterproofing membrane and traffic topping specified for the top deck level, with new drainage slope and drain location design to eliminate ponding." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">WATERTIGHT & STRUCTURALLY SOUND</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The parkade restoration eliminated the ongoing water infiltration and restored full structural capacity to all compromised PT slab zones. The new waterproofing system has performed without leaks since installation, and all fractured tendon zones have been remediated to code-compliant standards.</p>
                  </div>
                </div>
              </Reveal>
            </div>
