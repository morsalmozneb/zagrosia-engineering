...
const scopeItems = [
  { label: "Veneer Condition Assessment", detail: "Full building facade survey to map deterioration zones, loose panels, and failed anchor locations" },
  { label: "Wind Load Analysis", detail: "Updated cladding wind pressure calculations per NBCC 2020 to benchmark existing anchor capacity" },
  { label: "Emergency Stabilization Design", detail: "Temporary anchor and netting specifications for immediate hazard mitigation during remediation planning" },
  { label: "Replacement Anchor Design", detail: "New mechanical anchor layout and sizing for compliant veneer reattachment to the concrete substrate" },
  { label: "Construction Monitoring", detail: "Site observation during remediation to verify anchor installation and veneer re-attachment per design" },
]

const keyFacts = [
  { label: "Location", value: "Calgary, AB" },
  { label: "Building Type", value: "Multi-Unit Strata Building" },
  { label: "Services", value: "Building Rehabilitation & Envelope Assessment" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">STRATA — STONE VENEER</span>
                <br />
                <span className="text-[#0052A5]">REMEDIATION</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural assessment and remediation design for deteriorating stone veneer cladding on a multi-unit strata building, restoring envelope integrity and occupant safety.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-5.png" alt="STRATA — STONE VENEER REMEDIATION" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">STRATA — STONE VENEER</span>
                      <span className="block text-[#0052A5]">REMEDIATION</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural assessment and remediation design for deteriorating stone veneer cladding on a multi-unit strata building, restoring envelope integrity and occupant safety.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved a full structural assessment of deteriorating stone veneer cladding on a multi-unit strata building in Calgary. The veneer system was showing signs of delamination, cracked mortar joints, and loose stone units — creating a falling hazard risk for occupants and pedestrians below.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering conducted a detailed field investigation, reviewed original construction documents, and developed a comprehensive remediation design. The scope included both emergency stabilization measures and a long-term cladding replacement strategy phased to minimize disruption to strata owners.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The original stone veneer anchoring system was found to be under-designed for the wind suction pressures required by current code. Many anchor ties had corroded due to inadequate corrosion protection, significantly reducing their load-carrying capacity and creating an imminent failure risk in certain panel zones.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Working on an occupied strata building required careful sequencing of remediation work to maintain safe access and protect balconies below active work zones. Temporary protection scaffolding and debris netting were specified as part of the structural remediation package.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Field Investigation", body: "Detailed visual survey, sounding tests, and selective destructive investigation to assess anchor condition, mortar integrity, and substrate condition behind the veneer panels." },
                  { step: "02", title: "Structural Assessment", body: "Analysis of existing veneer anchor capacity against current wind suction demands. Identification of critical zones requiring immediate stabilization versus areas suitable for phased replacement." },
                  { step: "03", title: "Remediation Design", body: "New veneer anchor layout designed per current ABBC requirements. Replacement cladding attachment details developed to accommodate the existing concrete substrate without full facade demolition." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">SAFE, COMPLIANT & OWNER-APPROVED</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The remediation program successfully eliminated the falling hazard and brought the building facade into compliance with current wind load requirements. All strata owners were kept informed throughout the phased work, and the project was completed without any incident or further facade failures.</p>
                  </div>
                </div>
              </Reveal>
            </div>
