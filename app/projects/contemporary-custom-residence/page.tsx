...
const scopeItems = [
  { label: "Gravity Load Design", detail: "Sizing of all beams, columns, and floor systems under dead, live, and snow load combinations per NBCC 2020" },
  { label: "Lateral System Design", detail: "Steel moment frame design to resist wind and seismic lateral forces across both principal axes of the building" },
  { label: "Cantilever & Long-Span Analysis", detail: "Deflection-controlled design of cantilevered decks and long-span beams to meet serviceability and strength limits" },
  { label: "Foundation Design", detail: "Frost-depth spread footing and grade beam design coordinated with geotechnical recommendations" },
  { label: "Construction Administration", detail: "Site visits and RFI responses during construction to confirm structural intent was correctly implemented" },
]

const keyFacts = [
  { label: "Location", value: "Calgary, AB" },
  { label: "Building Type", value: "Custom Luxury Residence" },
  { label: "Services", value: "Structural Design & Architectural Engineering" },
  { label: "Jurisdiction", value: "City of Calgary" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">CONTEMPORARY CUSTOM</span>
                <br />
                <span className="text-[#0052A5]">RESIDENCE</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Full structural engineering for a luxury contemporary residence featuring open-concept layouts, cantilevered elements, and large-span architectural glazing systems.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-2.png" alt="CONTEMPORARY CUSTOM RESIDENCE" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">CONTEMPORARY CUSTOM</span>
                      <span className="block text-[#0052A5]">RESIDENCE</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Full structural engineering for a luxury contemporary residence featuring open-concept layouts, cantilevered elements, and large-span architectural glazing systems.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved complete structural engineering for a custom luxury residence in Calgary, Alberta. The open-concept architectural program required long-span steel beams, cantilevered deck systems, and moment-frame connections designed to minimize interior columns while maintaining structural integrity.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering collaborated closely with the architect and general contractor from design development through construction administration, ensuring all structural systems were coordinated with the architectural vision and mechanical/electrical routing.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The architectural design called for cantilevered overhangs exceeding three metres and a continuous glazing wall spanning the full width of the main floor. Achieving these elements required careful load path analysis and connection detailing to transfer lateral and gravity loads without visible structure.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Site constraints in Calgary's freeze-thaw climate required frost-depth foundation design and careful consideration of differential settlement. Coordination with the geotechnical report was critical to selecting appropriate footing sizes and embedment depths for the challenging soil conditions.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Architectural Coordination", body: "Structural framing was developed in close coordination with the architectural drawings to achieve long-span open-plan spaces, cantilevered elements, and recessed beam pockets without compromising ceiling heights." },
                  { step: "02", title: "Connection Design", body: "Custom moment frame connections were designed and detailed for the steel primary structure, allowing large glass openings while providing lateral resistance against wind and seismic demands." },
                  { step: "03", title: "Foundation Engineering", body: "Spread footings and grade beams were sized to meet frost-depth requirements and soil bearing capacity, with design coordinated against the geotechnical report recommendations." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">CODE-COMPLIANT & ARCHITECTURALLY INTEGRATED</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The completed residence achieved all architectural objectives — open-plan living, large-span glazing, and cantilevered outdoor decks — while meeting NBCC 2020 structural requirements. The project was delivered on schedule with no structural deficiencies identified during final inspection.</p>
                  </div>
                </div>
              </Reveal>
            </div>
