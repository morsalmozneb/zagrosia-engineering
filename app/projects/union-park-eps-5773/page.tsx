...
const scopeItems = [
  { label: "Wood Frame Gravity Design", detail: "Complete floor, wall, and roof framing design for all residential building blocks" },
  { label: "Shear Wall Layout", detail: "Lateral load analysis and shear wall schedule for wind and seismic resistance" },
  { label: "Snow Drift Analysis", detail: "Roof framing design with drift accumulation calculations at all roof level transitions" },
  { label: "Foundation Design", detail: "Strip footing design with engineered fill specifications for expansive clay soil conditions" },
  { label: "Permit Drawing Set", detail: "Structural drawings and calculations for City of Saskatoon building permit submission" },
]

const keyFacts = [
  { label: "Location", value: "Saskatoon, SK" },
  { label: "Building Type", value: "Multi-Family Residential" },
  { label: "Services", value: "Residential Structural Engineering" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">UNION PARK</span>
                <br />
                <span className="text-[#0052A5]">EPS 5773</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural engineering for a new residential development in Union Park, Saskatoon, including foundation design, wood framing, and lateral load system for multi-family residential units.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-8.png" alt="UNION PARK EPS 5773" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">UNION PARK</span>
                      <span className="block text-[#0052A5]">EPS 5773</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural engineering for a new residential development in Union Park, Saskatoon, including foundation design, wood framing, and lateral load system for multi-family residential units.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project involved structural engineering for a new residential development in Saskatoon's Union Park neighbourhood. The project encompassed multiple residential building blocks with wood-frame construction, designed to meet NBCC 2020 structural requirements for gravity, wind, and seismic loading.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering provided full structural design from preliminary engineering through permit drawing production, working alongside the project architect to coordinate shear wall placement, beam sizing, and foundation layout across the site's varying grade conditions.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The Union Park site is situated on expansive clay soils known to experience seasonal shrink-swell movement. Foundation design required careful consideration of soil conditions to minimize differential settlement, with engineered fill specifications and moisture barrier requirements incorporated into the foundation package.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Saskatchewan's design snow load of 1.9 kPa governed many roof framing members and required careful attention to drift accumulation at lower roof sections adjacent to higher building elements. Roof framing layouts were adjusted to manage snow drift loads without exceeding allowable member sizes.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Gravity Framing Design", body: "Floor joist, roof rafter, and beam systems designed for all unit types under NBCC 2020 dead, live, and snow load combinations including drift accumulation at roof level changes." },
                  { step: "02", title: "Lateral Shear Wall Design", body: "Wood shear wall layout optimized for seismic and wind demands, with nailing schedules, hold-downs, and drag strut connections coordinated with the architectural plans." },
                  { step: "03", title: "Foundation Engineering", body: "Continuous strip footing design accounting for expansive clay soil conditions, with engineered fill and drainage specifications to mitigate seasonal movement." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">PERMITTED & CONSTRUCTION-READY</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The Union Park residential development received building permit approval from the City of Saskatoon. Structural drawings were issued for construction with all comments addressed, and the project proceeded to construction on the planned schedule.</p>
                  </div>
                </div>
              </Reveal>
            </div>
