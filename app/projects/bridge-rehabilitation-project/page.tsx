...
const scopeItems = [
  { label: "Bridge Condition Survey", detail: "Full deck, soffit, and substructure inspection including chloride sampling and ground-penetrating radar" },
  { label: "Load Rating Analysis", detail: "CSA S6-19 load rating to assess current CL-625 truck carrying capacity of all bridge elements" },
  { label: "Concrete Repair Design", detail: "Delamination repair specifications including surface preparation, patch mix, and overlay requirements" },
  { label: "Rebar Replacement Detailing", detail: "Splice and replacement details for sections with excessive reinforcement section loss" },
  { label: "Cathodic Protection System", detail: "Embedded anode cathodic protection system design to arrest chloride-induced reinforcement corrosion" },
]

const keyFacts = [
  { label: "Location", value: "Saskatoon, SK" },
  { label: "Building Type", value: "Municipal Bridge Structure" },
  { label: "Services", value: "Bridge Rehabilitation & Structural Assessment" },
  { label: "Jurisdiction", value: "City of Saskatoon" },
  { label: "Code", value: "CHBDC CSA S6-19 / NBCC 2020" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">BRIDGE</span>
                <br />
                <span className="text-[#0052A5]">REHABILITATION PROJECT</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural rehabilitation engineering for a deteriorated municipal bridge, including condition assessment, load rating analysis, and concrete repair and strengthening design.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-11.png" alt="BRIDGE REHABILITATION PROJECT" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">BRIDGE</span>
                      <span className="block text-[#0052A5]">REHABILITATION PROJECT</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural rehabilitation engineering for a deteriorated municipal bridge, including condition assessment, load rating analysis, and concrete repair and strengthening design.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project provided structural rehabilitation engineering for a deteriorating municipal bridge in Saskatoon. The bridge, a reinforced concrete deck structure, was showing signs of concrete delamination, corroded reinforcement, and reduced load-carrying capacity due to years of freeze-thaw cycling and deicing salt penetration.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering conducted a load rating analysis per CSA S6-19 to assess the bridge's current carrying capacity and identify elements requiring intervention. A phased rehabilitation program was developed to restore the bridge to full service load capacity with minimal traffic disruption.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The bridge remained open to traffic throughout the assessment and initial remediation phases, requiring careful scheduling of investigation and repair work to minimize lane closures. The structural assessment needed to confirm adequate capacity for continued service while repair work was sequenced and tendered.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Chloride-induced corrosion had penetrated to the reinforcement mat in the deck and barrier walls, causing significant section loss in the rebar. A cathodic protection system was specified in combination with concrete patching to arrest further corrosion rather than undertaking a full deck replacement.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Bridge Condition Assessment", body: "Full visual survey, delamination sounding, chloride content testing, and ground-penetrating radar scan of the deck slab and soffit to map deterioration extent and depth of corrosion." },
                  { step: "02", title: "Load Rating Analysis", body: "Structural load rating performed per CSA S6-19 to establish current CL-625 truck capacity and identify members below acceptable rating thresholds requiring immediate repair or restriction." },
                  { step: "03", title: "Rehabilitation Design", body: "Concrete repair specifications, rebar splice and replacement details, and cathodic protection system design developed to restore full load-carrying capacity and extend service life by 30+ years." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">RESTORED TO FULL SERVICE LOAD</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>Following the rehabilitation program, the bridge was re-rated to full CL-625 service load capacity and reopened without load restrictions. The cathodic protection system is performing within design parameters, and the bridge is projected to meet its 30-year extended service life target without major structural intervention.</p>
                  </div>
                </div>
              </Reveal>
            </div>
