...
const scopeItems = [
  { label: "Core Wall Seismic Design", detail: "Dynamic analysis and ductile core wall design with boundary element and coupling beam detailing" },
  { label: "PT Flat Plate Design", detail: "Post-tensioned slab design for all residential and office floor levels" },
  { label: "Transfer Slab Design", detail: "Post-tensioned band beam transfer system at the podium-to-tower transition level" },
  { label: "Deep Foundation Engineering", detail: "High-capacity cast-in-place pile design for gravity and seismic overturning demands" },
  { label: "Construction Administration", detail: "Site observation, RFI management, and shop drawing review throughout construction" },
]

const keyFacts = [
  { label: "Location", value: "Burnaby, BC" },
  { label: "Building Type", value: "Mixed-Use High-Rise Tower" },
  { label: "Services", value: "High-Rise Structural Design & Seismic Engineering" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">MIXED-USE TOWER</span>
                <br />
                <span className="text-[#0052A5]">DEVELOPMENT</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural engineering for a mixed-use high-rise tower in Burnaby featuring concrete core walls, post-tensioned transfer slab, and deep foundation system for a seismically active site.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-14.png" alt="MIXED-USE TOWER DEVELOPMENT" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">MIXED-USE TOWER</span>
                      <span className="block text-[#0052A5]">DEVELOPMENT</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural engineering for a mixed-use high-rise tower in Burnaby featuring concrete core walls, post-tensioned transfer slab, and deep foundation system for a seismically active site.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project delivered structural engineering for a mixed-use high-rise tower in Burnaby, BC, comprising commercial retail at grade, office floors on the podium levels, and residential suites above. The tower's structural system used a reinforced concrete core wall for lateral resistance combined with a post-tensioned flat plate for gravity framing.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering provided full structural design services from schematic engineering through construction administration, including dynamic analysis of the concrete core wall system, post-tensioned slab design, transfer slab design at the podium-to-tower transition, and deep pile foundation engineering.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The tower's height and Burnaby's high seismic hazard required a dynamic analysis of the concrete core wall system per NBCC 2020 seismic provisions. The ductile core wall system demanded special detailing of boundary elements, coupling beams, and base connection to the foundation — all requiring careful coordination with the concrete contractor's forming capabilities.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The transition from the larger-footprint podium to the smaller tower floor plate required a post-tensioned transfer slab to redirect gravity loads from eliminated columns above. The transfer slab design governed many foundation loads and required iterative coordination between the slab design and the pile foundation sizing.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Dynamic Seismic Analysis", body: "Response spectrum analysis performed for the concrete core wall system. Ductility-related and overstrength-related force modifications (Rd, Ro) applied per NBCC 2020 for moderately ductile core walls." },
                  { step: "02", title: "PT Slab & Transfer Design", body: "Post-tensioned flat plate floors designed for residential and office loading, with the transfer slab detailed as a post-tensioned band beam system to span the eliminated podium columns." },
                  { step: "03", title: "Deep Foundation Design", body: "High-capacity cast-in-place concrete piles designed for the combined gravity and seismic overturning loads, with pile caps designed for biaxial moment transfer from the core wall base." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">COMPLEX STRUCTURE, DELIVERED ON BUDGET</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The mixed-use tower was completed within the project schedule and budget. The dynamic seismic analysis was accepted by the peer reviewer without major revision, and the post-tensioned transfer slab was constructed without incidents. The tower has been fully leased and occupied since project completion.</p>
                  </div>
                </div>
              </Reveal>
            </div>
