...
const scopeItems = [
  { label: "Gymnasium Roof Structure", detail: "Long-span open-web steel joist and girder system design for 30m clear-span gymnasium roof" },
  { label: "Lateral Bracing System", detail: "Steel braced frame design for seismic and wind resistance with importance factor IE = 1.3" },
  { label: "Concrete Floor Slab Design", detail: "Reinforced concrete slab-on-grade design for gymnasium floor loading and activity room finishes" },
  { label: "Foundation Design", detail: "Spread footing and grade beam design for frost depth and soil bearing conditions in Saskatoon" },
  { label: "Structural Drawings & Specifications", detail: "Complete permit and construction drawing set for City of Saskatoon building permit" },
]

const keyFacts = [
  { label: "Location", value: "Saskatoon, SK" },
  { label: "Building Type", value: "Community Recreation Centre" },
  { label: "Services", value: "Structural Engineering & Long-Span Design" },
  { label: "Jurisdiction", value: "City of Saskatoon" },
  { label: "Code", value: "NBCC 2020 / SKBC 2019" },
          ...
          <div className="relative pl-[12px]">
            ...
            <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
              <h1 className="mb-5 text-[24px] font-black uppercase leading-[1.25] tracking-[0.12em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#2D2D2D]">CLOVERDALE</span>
                <br />
                <span className="text-[#0052A5]">REC CENTRE</span>
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.25} duration={0.65}>
              <p className="mt-4 text-[12px] leading-[1.75] tracking-[0.08em] text-[#2D2D2D]">Structural engineering for a community recreation centre including long-span roof systems, gymnasium framing, and seismic design for a public institutional occupancy.</p>
            </Reveal>
          </div>
          <Reveal variant="fadeBlur" delay={0.15} duration={0.7}>
            <div className="relative mt-8 h-[220px] w-full overflow-hidden rounded-[16px]">
              <Image src="/images/Project-Card-6.png" alt="CLOVERDALE REC CENTRE" fill className="object-cover object-center" />
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative pl-5">
                  ...
                  <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
                    <h1 className="text-[52px] font-bold uppercase leading-[0.96] tracking-[0.06em]" style={{ fontFamily: "'Inter', sans-serif" }}>
                      <span className="mb-[8px] block text-[#2D2D2D]">CLOVERDALE</span>
                      <span className="block text-[#0052A5]">REC CENTRE</span>
                    </h1>
                  </Reveal>
                  <Reveal delay={0.2} duration={0.65}>
                  ...
                  <Reveal delay={0.22} duration={0.65}>
                    <p className="leading-[1.5] tracking-[0.14em] text-[#2D2D2D]" style={{ fontSize: "18px" }}>Structural engineering for a community recreation centre including long-span roof systems, gymnasium framing, and seismic design for a public institutional occupancy.</p>
                  </Reveal>
                </div>
              </div>
              ...
              <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-14">
                <div>
                  ...
                  <Reveal variant="fadeUp" delay={0.12}>
                    <p className="mb-5 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>This project delivered complete structural engineering for a new community recreation centre in Saskatoon, Saskatchewan. The facility included a full-size gymnasium, multi-purpose activity rooms, and administrative areas — each with distinct structural requirements for span, clearance, and loading.</p>
                  </Reveal>
                  <Reveal variant="fadeUp" delay={0.18}>
                    <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>Zagrosia Engineering designed a hybrid steel and concrete structure optimized for the facility's large-span spaces and public occupancy requirements. The gymnasium roof system used long-span steel joists to achieve the clear span needed for court sports without intermediate columns.</p>
                  </Reveal>
                </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <Reveal variant="fadeUp" delay={0.12}>
                  <p className="mb-6 lg:mb-0 leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>The gymnasium required a clear internal span of over 30 metres with no intermediate supports, and a minimum clear height of 8.5 metres to the underside of structure. Achieving this with an economical roof system while meeting the Saskatchewan snow load of 1.8 kPa required careful selection and optimization of the joist and purlin framing.</p>
                </Reveal>
                <Reveal variant="fadeUp" delay={0.18}>
                  <p className="leading-[1.65] tracking-[0.08em] text-[#2D2D2D]" style={{ fontSize: "16px" }}>As a public assembly occupancy, the recreation centre required enhanced seismic detailing and a higher importance factor per NBCC. The lateral system was designed as a steel braced frame, with careful coordination of brace locations to avoid conflict with door openings and mechanical distribution routes.</p>
                </Reveal>
              </div>
            </div>
          </div>
          ...
          <div className="sidebar-content zag-desktop-content-pad px-5">
            <div className="mx-auto max-w-[860px]">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-5">
                {[
                  { step: "01", title: "Long-Span Roof Design", body: "Open-web steel joists and girders selected and designed for the gymnasium roof, achieving the required clear span and height while managing deflection under full snow load." },
                  { step: "02", title: "Seismic System Design", body: "Steel braced frames designed as the lateral load-resisting system, with importance factor IE = 1.3 applied per NBCC for post-disaster and assembly occupancy classification." },
                  { step: "03", title: "Foundation Engineering", body: "Spread footings designed for the Saskatoon soil conditions with adequate frost depth embedment. Column base plates and anchor rods detailed for combined gravity and lateral uplift demands." }
                ].map((item, i) => (
                  <motion.div
                    key={item.step}
              ...
              <Reveal variant="fadeBlur" delay={0.12}>
                <div className="rounded-[20px] p-px" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                  <div className="rounded-[19px] px-8 py-10" style={{ background: "linear-gradient(135deg, #0052A5 0%, #003d7a 100%)" }}>
                    <p className="mb-3 text-[14px] font-bold tracking-[0.22em] text-white/70">OPEN TO THE COMMUNITY</p>
                    <p className="leading-[1.65] tracking-[0.08em] text-white/85" style={{ fontSize: "16px" }}>The Cloverdale Recreation Centre opened on schedule and passed all structural inspections. The long-span gymnasium achieved the required clear height and span, and the facility has been in active community use since opening. No structural deficiencies were identified during construction or post-occupancy review.</p>
                  </div>
                </div>
              </Reveal>
            </div>
