  ...
  return (
    <footer id="contact" className="bg-[#000000] py-8 text-[#FCFCFC] lg:py-10">
      ...
      <div className="lg:hidden mb-8">
        ...
        <h3 className="mb-5 text-[12px] font-medium tracking-[0.14em] text-[#FCFCFC]">Engineered to Solve</h3>
        <p className="mb-10 max-w-[305px] text-[11px] leading-[1.46] tracking-[0.14em] text-[#FCFCFC]/78">
          A next-generation structural engineering ecosystem, combining 35+ years of expertise with AI automation, education, and industry partnerships across Western Canada.
        </p>
      ...
      <div className="lg:hidden">
        ...
        <Link
          href="/contact"
          className="zag-outline-button mb-11 min-h-[48px] w-[152px] border-[#FCFCFC] px-0 text-[10px] tracking-[0.18em] text-[#FCFCFC] transition-colors hover:bg-[#94B8DC] hover:border-[#94B8DC] hover:text-white"
        >
          Contact us
        </Link>
      </div>
      ...
      <div className="border-t border-[#FCFCFC]/12 pt-5">
        <p className="max-w-[310px] text-[10px] leading-[1.42] tracking-[0.11em] text-[#FCFCFC]/46 lg:max-w-none">
