...
export function AboutPageHeader() {
  ...
  return (
    <header className="hero-content fixed top-3 z-50 lg:absolute lg:top-0 lg:left-0 lg:right-0" style={{ left: "23px", right: "23px" }}>
      ...
      <div
        ...
        style={{ paddingLeft: "max(24px, calc(var(--desktop-grid-content-start, 0px) + 4px))" }}
      >
