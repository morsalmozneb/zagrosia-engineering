...
const projects = [
  {
    ...
    tags: ["Retrofit", "Seismic", "Commercial"],
    location: "Burnaby, BC",
  ...
  },
  {
    ...
    tags: ["Industrial", "Steel", "Foundation"],
    location: "Burnaby, BC",
  ...
  },
  {
    ...
    tags: ["Residential", "Wood", "BCBC 2024"],
    location: "Burnaby, BC",
  ...
  },
  {
    ...
    tags: ["Remediation", "Masonry", "Envelope"],
    location: "Calgary, AB",
      ...
      <div className="lg:hidden">
        ...
        <div className="-mt-[2px] pb-0 pt-1">
          ...
          <div className="mt-8 flex justify-center pb-10">
            <CtaButton href="/projects" className="inline-flex items-center justify-center rounded-full border border-[#FCFCFC] text-[#FCFCFC] font-medium tracking-[0.1em] transition-colors hover:bg-[#0052A5] hover:border-[#0052A5] hover:text-white h-[40px] px-5 text-[11px] lg:h-[44px] lg:px-7 lg:text-[14px]">
              View All Projects
            </CtaButton>
          </div>
