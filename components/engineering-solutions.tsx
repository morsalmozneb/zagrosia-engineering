...
import { Reveal, StaggerReveal } from "./scroll-reveal"
    ...
    <section id="services" className="bg-[#FCFCFC] text-[#2D2D2D]">
      ...
      <div className="sidebar-content px-6 pb-10 pt-12 lg:pt-20 lg:pb-14 zag-desktop-content-pad">
        <div className="relative pl-5 lg:max-w-[940px]">
          ...
          {/* Vertical fading line — draws in from top */}
          <motion.div
            className="absolute left-0 top-0 w-[1.5px]"
            style={{
              height: "100%",
              background: "linear-gradient(to bottom, rgba(45,45,45,1) 0%, rgba(45,45,45,0.8) 30%, rgba(45,45,45,0.4) 65%, rgba(45,45,45,0) 100%)",
              transformOrigin: "top",
            }}
          ...
          <Reveal variant="fadeLeft" delay={0.1} duration={0.7}>
            <h2 className="zag-heading mb-5 font-medium uppercase leading-[1.1] lg:font-normal lg:text-[45px] lg:leading-[1.1]" style={{ fontSize: "20px" }}>
          ...
          {/* Accordion — each row staggers in */}
                ...
                >
                  {isOpen ? (
                    ...
                    >
                      ...
                      {service.image && (
                        <div className="relative mt-3 h-[140px] w-full overflow-hidden rounded-[10px] lg:h-[220px]">
          ...
          {/* Learn More CTA */}
          <Reveal variant="scaleUp" delay={0.3} duration={0.55}>
            <div className="mt-7">
              <CtaButton
                href="/services"
